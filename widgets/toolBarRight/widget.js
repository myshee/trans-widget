  ...
  class MyWidget extends mars3d.widget.BaseWidget {
    ...
    create() {
      ...
      this.data = this.config.data || [
        {name: 'iframe转换', widget: 'widgets/_example/widget.js'},
        {name: 'indiv转换', widget: 'widgets/_example_divwin/widget.js'},
        {name: '2div弹窗', widget: 'widgets/_example_2win/widget.js'},
        {name: 'append弹窗', widget: 'widgets/_example_append/widget.js'},
